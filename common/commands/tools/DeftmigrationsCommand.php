...
yiic deft --migrationPath=common.migrations

FULL DUMP

yiic deft TableDump --name=full2 --tableName=

ONLY_SCHEMA

yiic deft TableSchema --name=full2 --tableName=
...
EOD;
        ...
        Yii::setPathOfAlias('deft',realpath(__DIR__));
            return 'deft.template';
    }
