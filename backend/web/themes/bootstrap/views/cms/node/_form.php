<fieldset class="form-content">
    ...
    <?php echo $form->textField($model,'['.$model->locale.']heading',array('class'=>'span8','placeholder'=>'heading')) ?>
	...
	<?php echo $form->textArea($model,'['.$model->locale.']css',array('class'=>'span8','rows'=>6,'placeholder'=>'css')) ?>
